        ...
        if args.editable:
            ...
            if os.path.exists(dest_path):
                if os.path.islink(dest_path):
                    self.logger.debug(f"Removing existing symbolic link at {dest_path}")
                    os.unlink(dest_path)
                elif os.path.isdir(dest_path):
                    self.logger.debug(f"Removing existing directory at {dest_path}")
            ...
            self.logger.debug(f"Tropical Rainfall package linked from {source_path} to {dest_path}")
