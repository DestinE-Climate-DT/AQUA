...
def plot_maps(
    ...
    **kwargs,
    ...
    fig.subplots_adjust(bottom=0.25, top=0.87, left=0.05, right=0.95, wspace=0.1, hspace=0.2)
...
def plot_maps_diff(
    ...
    style=None,
    figsize=None,
    vmin_fill: float = None,
    vmax_fill: float = None,
    vmin_contour: float = None,
    vmax_contour: float = None,
    nlevels: int = 11,
    title: str = None,
    titles: list = None,
    titles_size: int = None,
    ...
    **kwargs,
    ...
    if (
        maps is None
        or any(not isinstance(data_map, xr.DataArray) for data_map in maps)
        or maps_ref is None
        or any(not isinstance(data_map, xr.DataArray) for data_map in maps_ref)
    ):
