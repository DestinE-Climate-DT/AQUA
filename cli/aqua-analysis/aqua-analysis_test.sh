...
# arguments.
# ---------------------------------------------------
export AQUA=/users/volpidan/AQUA/

model_atm="IFS"
model_oce="NEMO"
#exp="historical-1990-nemo-dev"
#source="monthly-1deg-3d"
exp="control-1990-nemo-dev"
source="hourly-native-3d"
outputdir="/scratch/project_465000454/volpidan/output_aqua/ocean_test"
