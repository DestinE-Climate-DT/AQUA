...
def parse_arguments(args):
    ...
    parser.add_argument("-c", "--config", type=str, required=True, help="yaml file with exp information and directories")
    parser.add_argument("-l", "--loglevel", type=str, help="log level [default: WARNING]")
    parser.add_argument("-z", "--zoom", type=str, help="override zoom: convenient for loop on many zoom levels")
...
if __name__ == "__main__":
    ...
    reader = Reader(model=model, exp=exp, source=source, areas=False, fix=False, loglevel=loglevel, **mykwargs)
