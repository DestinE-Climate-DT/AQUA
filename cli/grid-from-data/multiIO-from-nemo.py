...
def parse_arguments(args):
    ...
    parser.add_argument("-c", "--config", type=str, required=False, help="yaml file with exp information and directories")
...
if __name__ == "__main__":
    ...
    data[var].isel(time=0).to_netcdf(
        filename, format="NETCDF4", engine="netcdf4", encoding={var: {"zlib": True, "complevel": 9}}
    )
