...
def get_plot_options(config: dict = None, var: str = None):
    ...
    return figure_size,plot_label,label_ncol,label_size,pdf_save,units
...
if __name__ == '__main__':
    ...
    figure_size,plot_label,label_ncol,label_size,pdf_save,units = get_plot_options(config,var)
