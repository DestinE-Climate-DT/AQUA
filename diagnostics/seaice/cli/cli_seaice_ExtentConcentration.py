...
"""
Sea ice Diagnostic CLI for extent and concentration diagnostics. Strongly Inspired from its SSH equivalent

This script allows users to execute sea ice diagnostics of extent and concentration using command-line arguments.
By default, it will read configurations from 'config_ExtentConcentration.yaml' unless specified by the user.
"""
...
def parse_arguments(args):
    ...
    parser.add_argument('--config', type=str, default='config_ExtentConcentration.yaml',
...
if __name__ == '__main__':
    ...
    logger = log_configure(log_name="SeaIce CLI ExtentConcentration", log_level=loglevel)
    ...
    logger.info("Running sea ice diagnostic Extent and Concentration...")
    ...
    print("Performing diagnostic SEA ICE EXTENT")
    ...
    print("Performing diagnostic SEA ICE CONCENTRATION")
