...
On Lumi (and possible other HPCs supported on DestinE-Climate-DT) you can rely on shared grid definition files that are already available on the system.
Please refer to the corresponding installation guideline for more information: :ref:`installation-lumi`.
