...
#SBATCH --job-name=control_italy
#SBATCH --output=control_italy_%j.out
#SBATCH --error=control_italy_%j.err
...
aqua lra --config lra_italy_prec-control.yaml -w 12 -d -l INFO
