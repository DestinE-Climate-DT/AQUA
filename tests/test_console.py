...
class TestAquaConsole():
    ...
    def test_console_lra(self, tmpdir, set_home, run_aqua, run_aqua_console_with_input): 
        ...
        path = os.path.join(os.path.join(mydir, 'lra_test'),
                            "ci/IFS/test-tco79/r1/r200/monthly/mean/global/2t_test-tco79_r1_r200_monthly_mean_global_202002.nc")
        ...
        path = os.path.join(os.path.join(mydir, 'lra_test'),
                            "ci/IFS/test-tco79/r1/r200/monthly/min/global/2t_test-tco79_r1_r200_monthly_min_global_202002.nc")
        assert os.path.isfile(path)
