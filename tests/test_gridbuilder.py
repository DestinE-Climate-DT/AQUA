...
class TestGridEntryManager:
    ...
    def test_gem_basic(self, model, aquagrid, cdogrid, original, kind):
        ...
        gem = GridEntryManager(model_name=model, original_resolution=original, grid_name=aquagrid)
    ...
    def test_gem_curvilinear(self):
        ...
        block = gem.create_grid_entry_block(
            path="orca2_oce_depth_v1.nc", horizontal_dims="cells", cdo_options="-f nc", remap_method="bil", vert_coord="depth"
        )
