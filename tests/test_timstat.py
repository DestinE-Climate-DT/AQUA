...
class TestTimmean():
    ...
    def test_timstat_compare(self, reader, data):
    ...
    def test_timmin_yearly_exclude_incomplete(self, reader, data):
    ...
    def test_timmean_yearly_center_time(self, reader, data):
    ...
    def test_timmean_monthly_center_time(self, reader, data):
    ...
    def test_timstd_daily_center_time(self, reader, data):
    ...
    def test_timmean_invalid_frequency(self, reader, data):
    ...
    def test_timstd_error(self, reader, data):
    ...
    def test_timstat_histogram(self, reader, data):
